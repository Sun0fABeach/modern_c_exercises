...
void change_price(Part inventory[], int num_parts);
  ...
  for (;;) {
    ...
    switch (code) {
      ...
      case 'u': update(inventory, num_parts);
                break;
      case 'r': change_price(inventory, num_parts);
                break;
 ...
 *        database.                                       *
 **********************************************************/
int part_comp(const void *p1, const void *p2)
{
...
void print(Part inventory[], int num_parts)
{
  ...
  qsort(inventory, num_parts, sizeof(struct part), part_comp);
